                    ...
                    <div id='hidden' class='col-4'>
                        <div class='bg-white pb-5 text-center rounded'>
                            ...
                            <form action='supprimer3.php' method='post'>
                                <button id='edit' type='button' class='btn btn-outline-success'>modifier</button>
                ...
                <div class='row mb-5'>
                    ...
                    <div id='mydiv' style='display:none' class='col-4'>
                        <form action='modifier2.php' method='post'>
                            ...
                            <div class='form-floating mt-4'>
                                <input type='text' name='new_username' id='new_username' placeholder='Enter the new username' class='form-control'>
