<?php
        ...
        $_SESSION["new_offer"] = $_POST['new_offer'];
        $new_offer = $_SESSION["new_offer"];
        if (!$conn) {
            die("Connection failed: " . mysqli_connect_error());
        }
        $sql = "INSERT INTO clients (email, password, telephone, offer, username)
        VALUES('$new_email','$new_password','$new_telephone', '$new_offer', '$new_username');";
        ...
        $sql4 = "UPDATE clients SET num_facture = '$numfacture' WHERE email = '$new_email'";
